...
namespace HandshakeClient.Services
{
    ...
    public partial class Client 
    {
        ...
        /// <summary>Dissociates the authenticated user from a group.</summary>
        /// <param name="groupId">The id of the group.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task GroupDissociateuserAsync(System.Guid? groupId)
        {
            return GroupDissociateuserAsync(groupId, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task GroupDissociateuserAsync(System.Guid? groupId, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/Group/DissociateUser?");
            if (groupId != null) 
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("groupId") + "=").Append(System.Uri.EscapeDataString(ConvertToString(groupId, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
    ...
    /// <summary>The handshake.Data.AssociatedUserData is an associated user.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.2.1.0 (Newtonsoft.Json v12.0.0.0)")]
    public partial class AssociatedUserData 
    {
        /// <summary>The id.</summary>
        [Newtonsoft.Json.JsonProperty("id", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Guid Id { get; set; }
    ...
    public partial class GroupGetData 
    {
        ...
        /// <summary>The post associated with this group.</summary>
        ...
        public System.Collections.Generic.ICollection<PostGetData> Posts { get; set; }
    
        /// <summary>The associated users.</summary>
        [Newtonsoft.Json.JsonProperty("users", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<AssociatedUserData> Users { get; set; }
